...
<div class="edit-about">
    ...
    <div class="image-wrapper">
        <div class="db-image" style="background-image:url('<%= images.get(i+1) %>');"></div>
        <form action="uploadEdit" method="post" enctype="multipart/form-data">
            ...
            <input type="file" name="image<%=i+1%>" id="imageUpload<%=i%>" accept="image/*" onchange="previewImage(event,<%=i%>)">
